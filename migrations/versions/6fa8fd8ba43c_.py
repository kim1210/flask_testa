...
Revision ID: 6fa8fd8ba43c
Revises: 4b3dcc2e70dc
Create Date: 2021-03-08 15:21:49.608576
...
revision = '6fa8fd8ba43c'
down_revision = '4b3dcc2e70dc'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('questioin_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['questioin_id'], ['question.id'], name=op.f('fk_question_voter_questioin_id_question'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name=op.f('fk_question_voter_user_id_user'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('user_id', 'questioin_id', name=op.f('pk_question_voter'))
    )
